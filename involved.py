# -*- coding: utf-8 -*-
"""
Created on Sun Jul 12 11:54:40 2015
...
# # your solution. this works but there is a better solution
# # see instructor's solution below
#def involved(courses, person):
#    res = {}    
#    for key in courses:
#        res[key] = []
#        for course in courses[key]:
#            for element in courses[key][course]:
#                if person == courses[key][course][element]:
#                    res[key].append(course)
#        if len(res[key]) == 0:
#            del res[key]
#    return res


# instructor's solution. This is better (fewer lines of code)
def involved(courses, person):
    res = {}
